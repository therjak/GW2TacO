...
const std::vector<EnumNamePair> BlendOpNames = {
    {COREBLENDOP_ADD, ("Add")},       {COREBLENDOP_SUB, ("Sub")},
    {COREBLENDOP_REVSUB, ("RevSub")}, {COREBLENDOP_MIN, ("Min")},
    {COREBLENDOP_MAX, ("Max")},       {-1, ""}};

const std::vector<EnumNamePair> CullModeNames = {{CORECULL_NONE, ("None")},
                                                 {CORECULL_CW, ("CW")},
                                                 {CORECULL_CCW, ("CCW")},
                                                 {-1, ""}};

const std::vector<EnumNamePair> FillModeNames = {{COREFILL_SOLID, ("Solid")},
...
const std::vector<EnumNamePair> SamplerNames = {{CORESMP_PS0, ("PS0")},
                                                {CORESMP_PS1, ("PS1")},
                                                {CORESMP_PS2, ("PS2")},
                                                {CORESMP_PS3, ("PS3")},
                                                {CORESMP_PS4, ("PS4")},
...
const std::vector<EnumNamePair> FilterNames = {
    ...
    {COREFILTER_MIN_POINT_MAG_LINEAR_MIP_POINT,
    ...
    {COREFILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR,
    ...
    {COREFILTER_COMPARISON_MIN_MAG_POINT_MIP_LINEAR,
     ("Comparison_Min_Mag_Point_Mip_Linear")},
    {COREFILTER_COMPARISON_MIN_POINT_MAG_LINEAR_MIP_POINT,
     ("Comparison_Min_Point_Mag_Linear_Mip_Point")},
    {COREFILTER_COMPARISON_MIN_POINT_MAG_MIP_LINEAR,
     ("Comparison_Min_Point_Mag_Mip_Linear")},
    {COREFILTER_COMPARISON_MIN_LINEAR_MAG_MIP_POINT,
     ("Comparison_Min_Linear_Mag_Mip_Point")},
    {COREFILTER_COMPARISON_MIN_LINEAR_MAG_POINT_MIP_LINEAR,
     ("Comparison_Min_Linear_Mag_Point_Mip_Linear")},
    {COREFILTER_COMPARISON_MIN_MAG_LINEAR_MIP_POINT,
     ("Comparison_Min_Mag_Linear_Mip_Point")},
    {COREFILTER_COMPARISON_MIN_MAG_MIP_LINEAR,
