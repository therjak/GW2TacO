...
TBOOL CWBMetricValue::IsAutoResizer() { return AutoSize; }

void CWBMetricValue::SetAutoSize(TBOOL Auto) { AutoSize = Auto; }
...
void CWBMosaicImage::SetTiling(int32_t Axis, TBOOL y) { Tiling[Axis] = y; }
