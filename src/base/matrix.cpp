...
CMatrix4x4 CMatrix4x4::Transposed() const {
  return CMatrix4x4(_11, _21, _31, _41, _12, _22, _32, _42, _13, _23, _33, _43,
                    _14, _24, _34, _44);
}
...
CMatrix4x4 CMatrix4x4::operator-() const {
  return CMatrix4x4(-_11, -_12, -_13, -_14, -_21, -_22, -_23, -_24, -_31, -_32,
...
CMatrix4x4 CMatrix4x4::operator*(const float f) const {
  return CMatrix4x4(_11 * f, _12 * f, _13 * f, _14 * f, _21 * f, _22 * f,
...
CMatrix4x4 CMatrix4x4::operator/(const float f) const {
  float fInv = 1.0f / f;
  return CMatrix4x4(_11 * fInv, _12 * fInv, _13 * fInv, _14 * fInv, _21 * fInv,
