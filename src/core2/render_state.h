...
struct COREBLENDDESCRIPTOR {
  ...
  COREBLENDFACTOR SrcBlend = COREBLENDFACTOR::COREBLEND_ZERO;
  COREBLENDFACTOR DestBlend = COREBLENDFACTOR::COREBLEND_ZERO;
  COREBLENDOP BlendOp = COREBLENDOP::COREBLENDOP_ADD;
  COREBLENDFACTOR SrcBlendAlpha = COREBLENDFACTOR::COREBLEND_ZERO;
  COREBLENDFACTOR DestBlendAlpha = COREBLENDFACTOR::COREBLEND_ZERO;
  COREBLENDOP BlendOpAlpha = COREBLENDOP::COREBLENDOP_ADD;
